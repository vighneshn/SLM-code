...
## slmdisplaysdk.SLMDisplay() like done in the examples.


# Import the SLM Display SDK:
from holoeye import slmdisplaysdk

def showSLMPreview(slm, scale = 0.0):
    ...
    slm.utilsSLMPreviewSet(slmdisplaysdk.SLMDisplay.SLMPreviewFlags.OnTop, scale)
